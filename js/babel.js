...
//
// Check out the demo right [here](http://larrywu.com/babel/), 
// and view the source on [Github](https://github.com/lw7360/babel).
...
function Babel(username) {
    ...
    // A user object that will be given to other users.
    var myUser = {
        username: username,
        publicKey: publicKey
    };

    // A mapping of all usernames to their public keys.
    var users = {};
    ...
    // The timestamp of the latest change in presence.
    var latestUpdate = 0;
    ...
    // or leaves the PubNub channel. Both methods can be changed by the
    // publicly accessible methods 'onMessage' and 'onPresence' respectively.
    ...
    // Delete a message from 'messages' object, after `TTL` seconds.
